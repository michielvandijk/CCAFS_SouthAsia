...
WaterCompare_def<- c("reg","ssp","scen3", "scen" ,"year", "ind1" , "value")


WaterCompare_0<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-0.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_1<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-1.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_2<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-2.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_3<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-3.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_4<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-4.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_5<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-5.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_6<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-6.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_7<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-7.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_8<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-8.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_9<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-9.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_10<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-10.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_11<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-11.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_12<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-12.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_13<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-13.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_14<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-14.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_15<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-15.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_16<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-16.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_17<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-17.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_18<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-18.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_19<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-19.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_20<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-20.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_21<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-21.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_22<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-22.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_23<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-23.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_24<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-24.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_25<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-25.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_26<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-26.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_27<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-27.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_28<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-28.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_29<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-29.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_30<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-30.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_31<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-31.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_32<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-32.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)
WaterCompare_33<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-33.gdx","Water_reg_Compare",names=WaterCompare_def,compress=T)


Water_reg_Compare<-merge(WaterCompare_0,WaterCompare_1 ,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_2	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_3	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_4	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_5	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_6	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_7	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_8	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_9	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_10 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_11 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_12	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_13	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_14	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_15	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_16	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_17	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_18	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_19	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_20 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_21 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_22	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_23	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_24	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_25	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_26	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_27	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_28	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_29	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_30 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare, WaterCompare_31 	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_32	,all.x = TRUE, all.y = TRUE)
Water_reg_Compare<-merge(Water_reg_Compare,	WaterCompare_33	,all.x = TRUE, all.y = TRUE)


write.csv(Water_reg_Compare,"R_data_figures/WaterCompare.csv", na="")
...
output_def<- c( "reg", "crop", "ind" ,"scen1", "gcm", "ssp", "year",  "value")


output_0<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-0.gdx","Output",names=output_def,compress=T)
output_1<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-1.gdx","Output",names=output_def,compress=T)
output_2<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-2.gdx","Output",names=output_def,compress=T)
output_3<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-3.gdx","Output",names=output_def,compress=T)
output_4<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-4.gdx","Output",names=output_def,compress=T)
output_5<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-5.gdx","Output",names=output_def,compress=T)
output_6<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-6.gdx","Output",names=output_def,compress=T)
output_7<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-7.gdx","Output",names=output_def,compress=T)
output_8<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-8.gdx","Output",names=output_def,compress=T)
output_9<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-9.gdx","Output",names=output_def,compress=T)
output_10<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-10.gdx","Output",names=output_def,compress=T)
output_11<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-11.gdx","Output",names=output_def,compress=T)
output_12<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-12.gdx","Output",names=output_def,compress=T)
output_13<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-13.gdx","Output",names=output_def,compress=T)
output_14<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-14.gdx","Output",names=output_def,compress=T)
output_15<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-15.gdx","Output",names=output_def,compress=T)
output_16<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-16.gdx","Output",names=output_def,compress=T)
output_17<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-17.gdx","Output",names=output_def,compress=T)
output_18<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-18.gdx","Output",names=output_def,compress=T)
output_19<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-19.gdx","Output",names=output_def,compress=T)
output_20<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-20.gdx","Output",names=output_def,compress=T)
output_21<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-21.gdx","Output",names=output_def,compress=T)
output_22<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-22.gdx","Output",names=output_def,compress=T)
output_23<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-23.gdx","Output",names=output_def,compress=T)
output_24<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-24.gdx","Output",names=output_def,compress=T)
output_25<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-25.gdx","Output",names=output_def,compress=T)
output_26<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-26.gdx","Output",names=output_def,compress=T)
output_27<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-27.gdx","Output",names=output_def,compress=T)
output_28<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-28.gdx","Output",names=output_def,compress=T)
output_29<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-29.gdx","Output",names=output_def,compress=T)
output_30<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-30.gdx","Output",names=output_def,compress=T)
output_31<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-31.gdx","Output",names=output_def,compress=T)
output_32<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-32.gdx","Output",names=output_def,compress=T)
output_33<- rgdx.param("H:/Water-SA/gdx/output_SSPs_CCAFS_CC-33.gdx","Output",names=output_def,compress=T)


output<-merge(output_0,output_1 ,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_2	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_3	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_4	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_5	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_6	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_7	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_8	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_9	,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_10 ,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_11 ,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_12	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_13	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_14	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_15	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_16	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_17	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_18	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_19	,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_20 ,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_21 ,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_22	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_23	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_24	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_25	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_26	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_27	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_28	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_29	,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_30 ,all.x = TRUE, all.y = TRUE)
output<-merge(output, output_31 ,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_32	,all.x = TRUE, all.y = TRUE)
output<-merge(output,	output_33	,all.x = TRUE, all.y = TRUE)


write.csv(output,"R_data_figures/output.csv", na="")
